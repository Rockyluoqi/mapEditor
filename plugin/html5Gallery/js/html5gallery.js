...
function loadHtml5Gallery(s) {
    ...
    jQuery.extend(jQuery.easing, {
        def: "easeOutQuad", swing: function (b, e, a, d, c) {
    ...
    m.fn.drag = function (b, e, a) {
        var d = "string" == typeof b ? b : "", c = m.isFunction(b) ? b : m.isFunction(e) ? e : null;
    ...
    var v = m.event, x = v.special, q = null, q = x.drag = {
        ...
        hijack: function (b, e, a, d, c) {
            if (a) {
                var k = b.originalEvent, f = b.type, h = e.indexOf("drop") ? "drag" : "drop", j, g = d || 0, t, p;
                d = !isNaN(d) ?
                    d : a.interactions.length;
                b.type = e;
                b.originalEvent = null;
                a.results = [];
                do if ((t = a.interactions[g]) && !("dragend" !== e && t.cancelled))p = q.properties(b, a, t), t.results = [], m(c || t[h] || a.droppable).each(function (c, d) {
                    ...
                    q.flatten(t.results), "dropinit" == e && (t.droppable = q.flatten(t.droppable)), "dragstart" == e && !t.cancelled && p.update(); while (++g < d);
                b.type = f;
                b.originalEvent = k;
    ...
    B.fn.html5boxTransition = function (b, e, a, d, c) {
        $parent = this;
        b = d.effect;
        var k = d.easing, f = d.duration, h = d.direction, j = null;
    ...
    l.fn.addHTML5VideoControls = function (b, e, a) {
        var d = "ontouchstart" in window, c = d ? "touchstart" : "mousedown", k = d ? "touchmove" : "mousemove", f = d ? "touchcancel" : "mouseup", h = d ? 48 : 36, j = null, g = null, t = !1, p = !0, q = null != navigator.userAgent.match(/iPod/i) || null != navigator.userAgent.match(/iPhone/i), m = l(this).data("ishd"), s = l(this).data("hd"), v = l(this).data("src"), n = l(this);
    ...
    b.fn.html5gallery = function (l) {
        ...
        e.prototype = {
            getParams: function () {
                ...
                (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function () {
                    var d = b(this).data("lazy-src") ?
                        b(this).data("lazy-src") : b(this).data("lazyload-src") ? b(this).data("lazyload-src") : b(this).attr("src"), c = d, e = b(this).attr("alt"), f = b(this).data("description") ? b(this).data("description") : b(this).data("information");
                    e || (e = "");
                    f || (f = "");
                ...
                for (var b = !1, c = 0; c < a.elemArray.length; c++)if (13 == a.elemArray[c][9] && a.elemArray[c][19] && a.elemArray[c][20]) {
                    b = !0;
                    break
                }
            ...
            createMarkup: function () {
                ...
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        var f = Math.round(a / 2 - e / 2), h = Math.round(c / 2 - d / 2);
                    ...
                    b(".html5gallery-viral-" + this.id).css({top: c + "px"});
            ...
            createStyleVertical: function () {
                ...
                2, e = Math.round((this.options.thumbheight - 2) / 2 - (this.options.thumbimageheight + 2 * this.options.thumbimageborder) / 2), c += " .html5gallery-tn-img-" + this.id + " {display:block; overflow:hidden; float:left; margin-top:" + e + "px; margin-left:" + d + "px; width:" + String(this.options.thumbimagewidth + 2 * this.options.thumbimageborder) + "px;height:" + String(this.options.thumbimageheight + 2 * this.options.thumbimageborder) + "px;}") : c += " .html5gallery-tn-img-" + this.id + " {display:none;}", this.options.thumbshowtitle ? (c += " .html5gallery-tn-title-" +
                    ...
                    if (!(this.options.thumbShowNum >= this.elemArray.length)) {
                        ...
                        var d =
                            a / (this.elemArray.length * (this.options.thumbheight + this.options.thumbgap) - this.options.thumbMaskHeight), d = d * (this.options.carouselSliderMax - this.options.carouselSliderMin);
                        b(".html5gallery-car-slider-" + this.id, this.$gallery).stop(!0).animate({top: d}, 300);
                    ...
                    d.stop(!0).animate({marginTop: -a}, 500);
                    this.updateCarouseButtons(-a);
                    ...
                    b(".html5gallery-car-slider-" + this.id, this.$gallery).css({top: c});
                    var e = this.elemArray.length * (this.options.thumbheight + this.options.thumbgap) - this.options.thumbMaskHeight, e = e * c / (this.options.carouselSliderMax - this.options.carouselSliderMin), e = Math.round(e / (this.options.thumbheight + this.options.thumbgap)), e = -1 * e * (this.options.thumbheight + this.options.thumbgap);
                    ...
                    if (0 != parseInt(a.css("margin-top"))) {
                        ...
                        0 > d && (d = 0);
                        a.animate({marginTop: -d}, 500, this.options.carouseleasing);
                ...
                if ("center" != this.options.imagetoolboxstyle) {
                    var a = Math.round(("bottom" == this.options.headerpos ? 0 : this.options.headerHeight) + this.options.height / 2 - 24), d = a + Math.round(this.options.height / 2) - 32, c = this.options.boxWidth -
                        48, e = this.options.showfullscreenbutton ? c - 48 : c;
                    ...
                    b(".html5gallery-lightbox-" + this.id).css({top: d + "px", left: c + "px"})
                }
                ...
                if ("never" != this.options.showimagetoolbox) {
                    ...
                    if ("center" == this.options.imagetoolboxstyle)a = " .html5gallery-toolbox-" + this.id + " {display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; overflow:hidden; position:relative; margin:0px auto; text-align:center; height:40px;}", a += " .html5gallery-toolbox-bg-" + this.id + " {display:block; left:0px; top:0px; width:100%; height:100%; position:absolute; filter:alpha(opacity=60); opacity:0.6; background-color:#222222; }", a += " .html5gallery-toolbox-buttons-" +
                        ...
                        var d = Math.round(("bottom" == this.options.headerpos ? 0 : this.options.headerHeight) + this.options.height / 2 - 24), c = d + Math.round(this.options.height / 2) - 32, e = this.options.width - 54, f = this.options.showfullscreenbutton ? e - 48 : e;
                ...
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    a = this.elemArray[this.curElem][9];
                    if (1 == a || this.showingPoster) {
                        var d = this.elemArray[this.curElem][10], c = this.elemArray[this.curElem][11], e;
                        if (this.isFullscreen) {
                        ...
                        var d = Math.round(a / 2 - f / 2), h = Math.round(e / 2 - c / 2);
                ...
                (this.options.carouselNavButton = !0), a += " .html5gallery-car-left-" + this.id + " { position:absolute; overflow:hidden; width:" + this.options.carouselarrowwidth + "px; height:" + this.options.carouselarrowheight + "px; left:0px; top:" + String(this.options.carouselHeight / 2 - this.options.carouselarrowheight / 2) + "px; background:url('" + this.options.skinfolder + "carousel_left.png') no-repeat 0px 0px;}  .html5gallery-car-right-" + this.id + " { position:absolute; overflow:hidden; width:" + this.options.carouselarrowwidth + "px; height:" +
                    ...
                    if (this.options.thumbShowNum >= this.elemArray.length)b(".html5gallery-car-left-" + this.id, this.$gallery).css({
                        ...
                        d ? b(".html5gallery-thumbs-" +
                            this.id, this.$gallery).css({marginLeft: c}) : b(".html5gallery-thumbs-" + this.id, this.$gallery).animate({marginLeft: c}, 500);
                    ...
                    if (0 != parseInt(a.css("margin-left"))) {
                        ...
                        0 > d && (d = 0);
                        a.animate({marginLeft: -d}, 500, this.options.carouseleasing);
                        this.updateCarouseButtons(-d)
                    }
                }, this.carouselNext =
                    function () {
                    ...
                    var d = b(".html5gallery-car-left-" + this.id, this.$gallery), c = b(".html5gallery-car-right-" + this.id, this.$gallery), e = -1 * (this.options.thumbTotalWidth - this.options.thumbMaskWidth + this.options.thumbgap);
                    0 == a ? (d.css({
                        "background-position": "-" + String(2 * this.options.carouselarrowwidth) + "px 0px",
                        cursor: ""
                    }), d.data("disabled", !0)) : d.data("disabled") && (d.css({
                ...
                var a = b(window).width(), d = this.elemArray[this.curElem][10], c = this.elemArray[this.curElem][11];
                ...
                var f = Math.max(e, b(document).height()), h = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : this.fullscreenWidth, j = this.elemArray[this.curElem][18] ?
                    Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : this.fullscreenHeight, h = Math.min(h / d, j / c);
                1 > h && (d *= h, c *= h);
                ...
                b(window).scroll(function () {
                    var a = b(".html5gallery-fullscreen-box-" + g.id, g.$fullscreen), d = window.innerHeight ? window.innerHeight : b(window).height(), d = b(window).scrollTop() + Math.round((d - a.height()) / 2);
                    a.css({top: d})
                });
                ...
                b(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).animate({height: c + 2 * this.fullscreenMargin}, "slow", function () {
                    b(this).animate({width: d + 2 * g.fullscreenMargin}, "slow", function () {
                ...
                var c = this.elemArray[this.curElem][9], c = this.isHd != a && b && (5 == c || 6 == c || 7 == c || 8 == c);
                this.isHd = a;
                ...
                if (!(0 > a)) {
                    ...
                    (this.options.lightbox || this.elemArray[this.curElem][22]) && !this.isFullscreen ? (d.css({cursor: "pointer"}), d.unbind("click").bind("click", function () {
                ...
                b(c).load(function () {
                    ...
                    var h = d.isFullscreen ? e : d.options.width, j = d.isFullscreen ? c : d.options.height, g = Math.round(h / 2 - e / 2), l = Math.round(j / 2 - c / 2);
                ...
                var h = Math.max(f, b(document).height()), j = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : this.fullscreenWidth, g = this.elemArray[this.curElem][18] ?
                    Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : this.fullscreenHeight, j = Math.min(j / a, g / d);
                1 > j && (a *= j, d *= j);
                ...
                c ? (b(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).css({
                    width: a + 2 * this.fullscreenMargin, height: d + 2 *
                    ...
                    width: a + 2 * this.fullscreenMargin, height: d + 2 * this.fullscreenMargin +
                ...
                b(".html5gallery-fullscreen-next-" + this.id, this.$fullscreen).css({top: Math.round(d / 2)});
                ...
                b(".html5gallery-elem-" + this.id, this.$fullscreen).css({width: a, height: d});
                b(".html5gallery-fullscreen-timer-" + this.id,
                    this.$fullscreen).css({top: String(d - 4) + "px"});
                ...
                var a = this.isFullscreen ?
                    this.$fullscreen : this.$gallery, d = b(".html5gallery-elem-" + this.id, a);
                ...
                var c = this, e = this.elemArray[this.curElem][10], f = this.elemArray[this.curElem][11], h = new Image;
                b(h).load(function () {
                    $preloading.remove();
                    var h, g, l;
            ...
            getFlashMovieObject: function (a) {
                ...
                var c = this.isFullscreen ? this.$fullscreen : this.$gallery, e = this.elemArray[this.curElem][10], f = this.elemArray[this.curElem][11];
                if (this.isFullscreen) {
                ...
                b(".html5gallery-elem-" + this.id, c).html("<div class='html5gallery-loading-center-" + this.id + "'></div><div class='html5gallery-elem-video-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + f + "px;height:" + e + "px;'></div>" + this.options.watermarkcode);
                this.isHTML5 = !1;
                ...
                var e = this.isFullscreen ? 0 : Math.round((this.options.height - c) / 2) + (this.options.slideshadow ? 4 : 0), f = this.isFullscreen ? 0 : Math.round((this.options.width - d) / 2) + (this.options.slideshadow ? 4 : 0);
                ...
                if (this.isFullscreen) {
                    var c =
                        this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : Math.min(c, this.fullscreenWidth), f = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : Math.min(e, this.fullscreenHeight);
                ...
                var d = this.isFullscreen ? this.$fullscreen :
                    this.$gallery, c = this.elemArray[this.curElem][10], e = this.elemArray[this.curElem][11];
                if (this.isFullscreen) {
                    var c = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : Math.min(c, this.fullscreenWidth), f = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : Math.min(e, this.fullscreenHeight);
                    this.adjustFullscreen(c, f);
                    e = c;
                    c = f
                } else b(".html5gallery-elem-" + this.id, this.$gallery).css({
                ...
                if (this.isFullscreen) {
                    var d = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17],
                        this.fullscreenWidth) : Math.min(d, this.fullscreenWidth), e = this.elemArray[this.curElem][18] ? Math.min(this.elemArray[this.curElem][18], this.fullscreenHeight) : Math.min(c, this.fullscreenHeight);
        ...
        this.each(function () {
            ...
            if ((!b(this).data("donotinit") || l && l.forceinit) && !b(this).data("inited")) {
                ...
                k = f.length;
                for (d = 0; 5 > d; d++)f = f.slice(0, k - 9 + d) + f.slice(k - 8 + d);
                -1 != this.options.htmlfolder.indexOf(f) && (this.options.fv = !1);
                k = b(window).width();
                if (this.options.screenquery)for (d in this.options.screenquery)k <= this.options.screenquery[d].screenwidth &&
...
function HTML5GallerySWFObjectFunc() {
    ...
    function v() {
        ...
        if (0 < b)for (var d = 0; d < b; d++) {
            var g = I[d].id, h = I[d].callbackFn, j = {success: !1, id: g};
            if (0 < r.pv[0]) {
                var k = e(g);
                if (k)if (a(I[d].swfVersion) && !(r.wk && 312 > r.wk))c(g, !0), h && (j.success = !0, j.ref = x(g), h(j)); else if (I[d].expressInstall && q()) {
                    j = {};
    ...
    return {
        registerObject: function (a, b, d, e) {
            ...
            r.w3 && !(r.wk && 312 > r.wk) && b && d && e && g && j ? (c(d, !1), w(function () {
                ...
                ("&" + v + "=" + l[v]) : v + "=" + l[v];
                if (a(j))u = G(r, s, d), r.id == d && c(d, !0), t.success = !0, t.ref = u; else {
                    if (k && q()) {
                        r.data = k;
                        B(r, s, d, p);
                        return
